...
# API endpoint to get user's past test results
...
def get_results():
    ...
    try:
        ...
        results = loop.run_until_complete(get_user_test_results(user_id))
...
# This block will only run if app.py is executed directly, not when imported
